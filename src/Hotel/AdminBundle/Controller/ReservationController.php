...
class ReservationController extends Controller
{
     ...
     * @Method("POST")
     * @Template("HotelAdminBundle:Reservation:new.html.twig")
     */
...
//        var_dump($request->query);
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HotelAdminBundle:Reservation')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HotelAdminBundle:Reservation:edit.html.twig")
     */
