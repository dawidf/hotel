...
use Hotel\AdminBundle\Entity\Client;
use Hotel\AdminBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HotelAdminBundle:Client')->findAll();
     ...
     * @Method("POST")
     * @Template("HotelAdminBundle:Client:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HotelAdminBundle:Client')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HotelAdminBundle:Client:edit.html.twig")
     */
